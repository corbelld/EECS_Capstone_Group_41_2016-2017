        ...
        <div class="row">
            <div class="box">
					...
					<?php
						...
						$query = "SELECT * FROM Careers C, CareerLink L, Opportunity O WHERE C.careerID = 'physician' AND L.careerID = 'physician' AND O.careerID = 'physician'"; 
						//echo $query;
						//echo $mysql_handle;
						...
						if(!$result){
							...
							$queryschools = "SELECT * FROM Careers C, CareerLink L, Schools S WHERE C.careerID = 'physician' AND L.careerID = 'physician' AND S.schoolID=L.schoolID"; 
							...
							echo    	"<hr>";
							$querystate = "SELECT * FROM Careers C, Opportunity O WHERE C.careerID = 'physician' AND O.careerID = 'physician' AND O.oppType = 'Oregon'"; 
							...
							echo    	"<hr>";
							$querynat = "SELECT * FROM Careers C, Opportunity O WHERE C.careerID = 'physician' AND O.careerID = 'physician' AND O.oppType = 'National'"; 
