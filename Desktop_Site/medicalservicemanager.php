        ...
        <div class="row">
            <div class="box">
					...
					<?php
						...
						$query = "SELECT * FROM Careers C, CareerLink L, Opportunity O WHERE C.careerID = 'medicalservicemanager' AND L.careerID = 'medicalservicemanager' AND O.careerID = 'medicalservicemanager'"; 
						//echo $query;
						//echo $mysql_handle;
						...
						if(!$result){
							...
							$queryschools = "SELECT * FROM Careers C, CareerLink L, Schools S WHERE C.careerID = 'medicalservicemanager' AND L.careerID = 'medicalservicemanager' AND S.schoolID=L.schoolID"; 
							...
							echo    	"<hr>";
							$querystate = "SELECT * FROM Careers C, Opportunity O WHERE C.careerID = 'medicalservicemanager' AND O.careerID = 'medicalservicemanager' AND O.oppType = 'Oregon'"; 
							...
							echo    	"<hr>";
							$querynat = "SELECT * FROM Careers C, Opportunity O WHERE C.careerID = 'medicalservicemanager' AND O.careerID = 'medicalservicemanager' AND O.oppType = 'National'"; 
